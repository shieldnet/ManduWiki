...
def macro(data):
    ...
    data = re.sub("\[recent_changes\]", '''<iframe name="ifr" id="ifr" src="/recent_changes_plain" scrolling="no" frameborder="0" style="width:100%;" onload="this.height=ifr.document.body.scrollHeight+15;">최근변경내역</iframe>
    ''', data)
